    ...
    <div class="container">
        <div class="row gy-4">
            ...
            <div class="col-lg-6 content">
                ...
                <ul>
                    <li><i class="bi bi-check2-all"></i> Мы используем технологии, которые позволяют значительно
                        снизить энергопотребление.
                    </li>
                    <li><i class="bi bi-check2-all"></i> Наши решения обеспечивают стабильную работу оборудования
                        даже в самых сложных условиях.
                    </li>
                    <li><i class="bi bi-check2-all"></i> Мы адаптируем наши решения под конкретные нужды вашего
                        предприятия.
                    </li>
                </ul>
                <p>
                    Мы уверены, что наши решения помогут вам достичь новых высот в производительности и
                    эффективности. Свяжитесь с нами, чтобы узнать больше о том, как мы можем помочь вашему бизнесу.
                </p>
            </div>
        </div>
    </div>
