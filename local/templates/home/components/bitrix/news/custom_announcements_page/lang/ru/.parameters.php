...
$MESS["SHOW_FILTER_TEMPLATE"] = "Применить отдельный компонент фильтрации и показать его шаблон на странице?";
$MESS["SHOW_FILTER_TEMPLATE_DESCRIPTION"] = "Данный параметр выводит на странице шаблон фильтра. Работает, если включен параметр в настройках фильтра 'Показывать фильтр'";
?>