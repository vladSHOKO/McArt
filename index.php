    ...
    <div class="slide-one-item home-slider owl-carousel">
        <div class="site-blocks-cover"
            ...
            <div class="text">
                ...
                <p class="mb-0"><a href="#" class="text-uppercase small letter-spacing-1 font-weight-bold">More
                        Details</a></p>
        ...
        <div class="site-blocks-cover"
             style="background-image: url(<?= SITE_TEMPLATE_PATH . "/" ?>images/hero_bg_3.jpg);" data-aos="fade"
             data-stellar-background-ratio="0.5">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-4 mb-5" data-aos="fade-up" data-aos-delay="200">
                    <a href="#"><img src="<?= SITE_TEMPLATE_PATH . "/" ?>images/img_2.jpg" alt="Image"
                                     class="img-fluid"></a>
                    <div class="p-4 bg-white">
                        <span class="d-block text-secondary small text-uppercase">Jan 20th, 2019</span>
                        <h2 class="h5 text-black mb-3"><a href="#">When To Sell &amp; How Much To Sell?</a></h2>
                ...
                <div class="col-md-6 col-lg-4 mb-5" data-aos="fade-up" data-aos-delay="300">
                    <a href="#"><img src="<?= SITE_TEMPLATE_PATH . "/" ?>images/img_3.jpg" alt="Image"
                                     class="img-fluid"></a>
                    <div class="p-4 bg-white">
                        <span class="d-block text-secondary small text-uppercase">Jan 20th, 2019</span>
                        <h2 class="h5 text-black mb-3"><a href="#">When To Sell &amp; How Much To Sell?</a></h2>
